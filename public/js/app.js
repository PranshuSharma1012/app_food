...
//         axios.post('/admin/orders').then((response) => {
//             console.log(response.data);

//             let html = ' <td class="border px-4 py-2">'+ response+'</td> <td class="border px-4 py-2"> </td> <td class="border px-4 py-2"> </td><td class="border px-4 py-2"> </td><td class="border px-4 py-2"> </td><td class="border px-4 py-2"> </td>';
...
$(document).ready(function () {
  ...
  socket.on('stockUpdated', function (data) {
    for (var _i = 0, _Object$keys = Object.keys(data.items); _i < _Object$keys.length; _i++) {
      var key = _Object$keys[_i];
      console.log(data.items[key].item);
      $('.menu-' + key).html(data.items[key].item.stock);
    }
  });
  socket.on('apiOrder', function (data) {
    console.log(data);
  ...
  function updateCart(pizza) {
    console.log(pizza);
    axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/update-cart', pizza).then(function (response) {
      console.log(response.data);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkapp_food"] = self["webpackChunkapp_food"] || [];
